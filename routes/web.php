...
Route::get('/perusahaan/detail/{id}','adminController@perusahaan_detail')->name('perusahaan_detail');
Route::put('/perusahaan/detail/{id}','adminController@perusahaan_update')->name('perusahaan_update');
